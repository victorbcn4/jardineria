...
CREATE TABLE empleados (
  ...
  CONSTRAINT empleados_oficinasFK FOREIGN KEY (codigo_oficina) REFERENCES oficinas (codigo_oficina),
  CONSTRAINT empleados_empleadosFK FOREIGN KEY (codigo_jefe) REFERENCES empleados (codigo_empleado)
) engine=innodb;
...
CREATE TABLE clientes (
  ...
  CONSTRAINT clientes_empleadosFK FOREIGN KEY (codigo_empleado_rep_ventas) REFERENCES empleados (codigo_empleado)
) engine=innodb;
...
CREATE TABLE pedidos (
  ...
  CONSTRAINT pedidos_Cliente FOREIGN KEY (codigo_cliente) REFERENCES clientes (codigo_cliente)
) engine=innodb;
...
CREATE TABLE productos (
  ...
  CONSTRAINT productos_gamaFK FOREIGN KEY (gama) REFERENCES gamas_productos (gama)
) engine=innodb;
...
CREATE TABLE detalle_pedidos (
  ...
  CONSTRAINT detalle_pedidos_pedidoFK FOREIGN KEY (codigo_pedido) REFERENCES pedidos (codigo_pedido),
  CONSTRAINT detalle_pedidos_productoFK FOREIGN KEY (codigo_producto) REFERENCES productos (codigo_producto)
)engine=innodb;
...
CREATE TABLE pagos (
  ...
  CONSTRAINT pagos_clienteFK FOREIGN KEY (codigo_cliente) REFERENCES clientes (codigo_cliente)
) engine=innodb;
